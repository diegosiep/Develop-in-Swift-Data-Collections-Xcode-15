...
var friendsAndFamily: [String] = ["Diego", "Maxi", "Cara", "Sabri", "Sabri 2.0", "Gonchis", "Teddy"]
let sortedCollection1 = friendsAndFamily.sorted(by: forwards(name1:name2:))
...
let sortedCollection2 = friendsAndFamily.sorted(by: {(name1: String, name2: String) -> Bool in
    return name1 < name2
})
